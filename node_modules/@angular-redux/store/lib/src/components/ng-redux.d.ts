import { Reducer, Dispatch, Unsubscribe, Middleware, Store, StoreEnhancer } from 'redux';
...
export declare abstract class NgRedux<RootState> implements ObservableStore<RootState> {
     ...
     */
    abstract configureStore: (rootReducer: Reducer<RootState>, initState: RootState, middleware?: Middleware[], enhancers?: StoreEnhancer<RootState>[]) => void;
    /**
    ...
    abstract configureSubStore: <SubState>(basePath: PathSelector, localReducer: Reducer<SubState>) => ObservableStore<SubState>;
}
